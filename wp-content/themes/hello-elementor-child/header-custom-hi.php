                            ...
                            <div class="row no-gutters">
                                <div class="col-lg-4 sidebar-widget">
                                    <div class="sidebar-info-widget">
                                        <a href="index.php" class="footer-logo"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/logo/logo.png" alt="ब्रांड लोगो"></a>
                ...
                <div class="container-fluid">
                    <div class="primary-menu">
                        ...
                        <div class="site-branding">
                            <a href="index.php" class="brand-logo"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/logo/logo.png" alt="साइट लोगो"></a>
                        </div>
                        <!--====== Nav Menu ======-->
                        <div class="nav-menu">
                            <!--====== Site Branding ======-->
                            ...
                            <div class="nav-search mb-30 d-block d-xl-none ">
                                <form>
                                    <div class="form_group">
                                        <input type="email" class="form_control" placeholder="यहां तलाश करो" name="email" required="">
                            ...
                            <nav class="main-menu">
                                <ul>
                                    <li class="menu-item has-children"><a href="/">होम</a>
                                       
                                    </li>
                                    <li class="menu-item"><a href="/about">हमारे बारे </a></li>
                                    <li class="menu-item has-children"><a href="/services">सेवाएं</a>
                                        
                                    </li>
                                    <li class="menu-item has-children"><a href="/solution">समाधान 	</a>
                                        
                                    </li>
                                    <li class="menu-item has-children"><a href="/expert">माहिर</a>
                                       
                                    </li>
                                    <li class="menu-item has-children"><a href="/blogs">ब्लॉग & समाचार</a>
                                      
                                    </li>
                                    <!-- <li class="menu-item has-children"><a href="blogs.html"></a>
                                      
                                    </li> -->
                                    <li class="menu-item has-children"><a href="/privacy">प्राइवेसी पालिसी</a>
                                        
                                    </li>
                                    <li class="menu-item has-children"><a href="/terms">नियम और शर्तें</a>
                                      
                                    </li>


                                   
                        <li class="menu-item has-children"><a href="#">भाषा<span class="dd-trigger"><i class="far fa-angle-down"></i></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?php echo $lastSlug ?>">अंग्रेज़ी</a></li>
                                <li><a href="<?php echo $lastSlug ?>-hi">हिंदी</a></li>
                                <li><a href="<?php echo $lastSlug ?>-bi">पंजाबी</a></li>
                            </ul>
                        </li>            
                        <li class="menu-item has-children">
                            <a href="https://app.mera.farm/accounts/login/?next=/" target="_self" id="loginLink">लॉग इन करें</a>
                        </li>
                    </ul>
                </nav>
                <!--====== Menu Button ======-->
                <div class="menu-button mt-40 d-xl-none">
                    <a href="/contact" class="main-btn secondary-btn">संपर्क</a>
                </div>
            </div>
                        <!--====== Nav Right Item ======-->
                        <div class="nav-right-item">
                            <div class="menu-button d-xl-block d-none">
                                <a href="/contact" class="main-btn primary-btn">संपर्क</a>
                            </div>
