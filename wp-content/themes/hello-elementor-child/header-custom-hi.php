...
<head>
        ...
        <!--====== Title ======-->
        <title>हमारे बारे में - मेरा फार्महाउस</title>
        <!--====== Favicon Icon ======-->
                    ...
                    <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="single-information-item">
                                            ...
                                            <div class="info">
                                                ...
                                                <h5><a href="mailto:info@merafarmhouse.com"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">info@merafarmhouse.com</font></font></a></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        ...
                                        <div class="single-information-item">
                                            ...
                                            <div class="info">
                                                <span>
                                                    हॉटलाइन</span>
                                                <h5><a href="tel:+919875968172"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">+91-987-596-8172</font></font></a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="menu-right-item">
                                ...
                                <span class="bar-btn" data-toggle="modal" data-target="#sidebar-modal"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/bar.png" alt="छवि"></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="header-navigation">
                    ...
                    <div class="primary-menu">
                        ...
                        <div class="site-branding">
                            <a href="index.html" class="brand-logo"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/logo/logo.png" alt="साइट लोगो"></a>
                            <a href="index.html" class="sticky-logo"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/logo/logo.png" alt="साइट लोगो"></a>
                        </div>
                        <!--====== Nav Menu ======-->
                        <div class="nav-menu">
                            <!--====== Site Branding ======-->
                            ...
                            <nav class="main-menu">
                                <ul>
                                    ...
                                    <li class="menu-item has-children"><a href="solution - bi.html">समाधान</a>
                                       
                                    </li>
                                    <li class="menu-item has-children"><a href="mentors.html">
                                        विशेषज्ञों</a>
                                       
                                    </li>
                                    <li class="menu-item has-children"><a href="blogs.html">ब्लॉग</a>
                                      
                                    </li>
                                    <li class="menu-item has-children"><a href="blogs.html">समाचार</a>
                                      
                                    </li>
                                    <li class="menu-item has-children"><a href="privacy.html">प्राइवेसी पालिसी</a>
                                       
                                    </li>
                                    <li class="menu-item has-children"><a href="terms.html">
                                        शर्तें</a>
                                    ...
                                    <li class="menu-item has-children">
                                        <a href="#" id="loginLink">लॉग इन करें</a>
                                    </li>
                            ...
                            <div class="menu-button mt-40 d-xl-none">
                                <a href="contact.html" class="main-btn secondary-btn"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">संपर्क</font></font></a>
                            </div>
                        </div>
                        ...
                        <div class="nav-right-item">
                            ...
                            <div class="menu-button d-xl-block d-none">
                                <a href="contact.html" class="main-btn primary-btn"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">संपर्क</font></font></a>
                            </div>
