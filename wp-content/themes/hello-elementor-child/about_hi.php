<?php
/*
Template Name: Custom about_hi Page
*/
 get_header('custom'); 
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="about-img-item mb-30 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                            <img src="assets/images/service/2.jpeg" alt="छवि के बारे में">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <!--====== About Image Item ======-->
                        <div class="about-img-item mb-30 wow fadeInDown" style="visibility: visible; animation-name: fadeInDown;">
                            <img src="assets/images/service/5.jpeg" alt="छवि के बारे में">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <!--====== About Image Item ======-->
                        <div class="about-img-item mb-30 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                            <img src="assets/images/service/7.jpeg" alt="छवि के बारे में">
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
