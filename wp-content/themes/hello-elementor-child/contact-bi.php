            ...
            <div class="row no-gutters justify-content-center">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="contact-info-item text-center">
                        <div class="icon">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icon/icon-1.png"
                                alt="icon">
                        </div>
                        <div class="info">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="contact-info-item text-center">
                        <div class="icon">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icon/icon-2.png"
                                alt="icon">
                        </div>
                        <div class="info">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="contact-info-item text-center">
                        <div class="icon">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icon/icon-3.png"
                                alt="icon">
                        </div>
                        <div class="info">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="map-box wow fadeInLeft mb-50">
                        ...
                        <iframe
                            src="https://maps.google.com/maps?q=new%20york&t=&z=13&ie=UTF8&iwloc=&output=embed"></iframe>
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-4 col-md-6">
                ...
                <div class="single-info-item style-one mb-40 wow fadeInUp">
                    <div class="shape shape-one"><span><img
                                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/shape/info-shape-1.png"
                                alt="shape"></span></div>
                    <div class="info">
            ...
            <div class="col-xl-4 col-md-6">
                ...
                <div class="single-info-item style-three mb-40 wow fadeInUp">
                    <div class="shape shape-one"><span><img
                                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/shape/info-shape-2.png"
                                alt="shape"></span></div>
                    <div class="info">
        ...
        <div class="partner-slider-one pt-80 pb-70 border-top-1 wow fadeInUp">
            <div class="single-partner-item">
                <div class="partner-img">
                    <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/gallery/1.jpg"
                            alt="Partner Image"></a>
                </div>
            </div>
            <div class="single-partner-item">
                <div class="partner-img">
                    <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/gallery/2.jpg"
                            alt="Partner Image"></a>
                </div>
            </div>
            <div class="single-partner-item">
                <div class="partner-img">
                    <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/gallery/4.jpg"
                            alt="Partner Image"></a>
                </div>
            </div>
            <div class="single-partner-item">
                <div class="partner-img">
                    <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/gallery/5.jpg"
                            alt="Partner Image"></a>
                </div>
            </div>
            <div class="single-partner-item">
                <div class="partner-img">
                    <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/gallery/6.jpg"
                            alt="Partner Image"></a>
                </div>
            </div>
            <div class="single-partner-item">
                <div class="partner-img">
                    <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/gallery/8.jpg"
                            alt="Partner Image"></a>
                </div>
            </div>
        </div>
