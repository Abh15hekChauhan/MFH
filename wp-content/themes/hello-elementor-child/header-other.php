                            ...
                            <div class="row no-gutters">
                                <div class="col-lg-4 sidebar-widget">
                                    <div class="sidebar-info-widget">
                                        <a href="/" class="footer-logo"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/logo/logo.png" alt="Brand Logo"></a>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="menu-right-item">
                                ...
                                <span class="bar-btn" data-toggle="modal" data-target="#sidebar-modal"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/bar.png" alt="Image"></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="header-navigation">
                    ...
                    <div class="primary-menu">
                        ...
                        <div class="site-branding">
                            <a href="/" class="brand-logo"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/logo/logo.png" alt="Site Logo"></a>
                            <a href="/" class="sticky-logo"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/logo/logo.png" alt="Site Logo"></a>
                        </div>
                        <!--====== Nav Menu ======-->
                        <div class="nav-menu">
                            <!--====== Site Branding ======-->
